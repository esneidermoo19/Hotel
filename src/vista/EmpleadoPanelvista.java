...
public class EmpleadoPanelvista extends JFrame {
    ...
    public EmpleadoPanelvista() {
        setTitle("Hotel La Orqu\u00eddea - Panel Recepci\u00f3n");
        setSize(1000, 640);
    ...
    private void buildNavbar() {
        ...
        nav.setPreferredSize(new Dimension(1000, 65));
        nav.setBorder(BorderFactory.createCompoundBorder(
            BorderFactory.createMatteBorder(0, 0, 2, 0, DORADO),
            new EmptyBorder(0, 30, 0, 30)));

        JLabel logo = new JLabel("LA ORQU\u00cdDEA  |  PANEL RECEPCI\u00d3N", SwingConstants.CENTER);
    ...
    private void buildContenido() {
        ...
        JPanel botonera = new JPanel(new FlowLayout(FlowLayout.CENTER, 15, 0));
